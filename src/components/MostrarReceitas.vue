<template>
    <section class="mostrar-receita">
        ...
        <div class="receitas-wrapper" v-if="receitasEncontradas.length">
        ...
        <div v-else class="receitas-nao-encontradas">
            <p class="paragrafo-lg receitas_nao_encontradas__info">
...
export default {
  ...
  async created() {
    ...
    this.receitasEncontradas = receitas.filter((receita) => {
      // logica que verifica se receita
      // todos ingredientes de uma receita devem estar inclusos na minha lista de ingredientes selecionaveis
